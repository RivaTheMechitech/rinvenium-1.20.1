...
public enum  EnviniumToolMaterial implements ToolMaterial {
    ...
    private EnviniumToolMaterial(int miningLevel, int itemDurability, float miningSpeed, float attackDamage, int enchantability, Supplier<Ingredient> repairIngredient) {
